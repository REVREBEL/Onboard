  ...
  try {
    ...
    const clientInsert = await pool.query(
      `INSERT INTO surveyjs.clients
       ...
       RETURNING *`,
      [hotel_name, location || null, pms_system || null, crs_system || null, rate_shopping_tool || null, rms_system || null, resolvedGoogleDriveFolderId]
    );
...
const startServer = async () => {
  ...
  app.listen(PORT, () => {
    console.log(`SurveyJS API listening on :${PORT}`);
  });
};
